  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-4">
        <button class="product-btn"><?php echo esc_html_e('ALL CATEGORIES','vw-book-store'); ?><i class="fa fa-bars" aria-hidden="true"></i></button>
      ...
      <div class="col-lg-2 col-md-1">
        <div class="cart_icon">
          <a href="<?php echo esc_html( get_theme_mod('vw_book_store_cart_link','' )); ?>"><i class="<?php echo esc_html(get_theme_mod('vw_book_store_cart_icon','fas fa-shopping-bag')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Cart','vw-book-store' );?></span></a>
