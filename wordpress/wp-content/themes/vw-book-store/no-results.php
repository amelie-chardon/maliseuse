...
<div class="title-box">
    <div class="container">
        <h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-book-store' ); ?></h2>
    </div>
</div>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<?php elseif ( is_search() ) : ?>
		<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vw-book-store' ); ?></p><br />
		<?php get_search_form(); ?>
	<?php else : ?>
